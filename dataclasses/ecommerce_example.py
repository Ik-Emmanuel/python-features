...
# field(default_factory=list)  creates and initializes as an empty list 
# def __post_init__(self) -> None: called after the class is initialized
# field(compare=True) compare True means this field can  be used to compare with another dataclass object
